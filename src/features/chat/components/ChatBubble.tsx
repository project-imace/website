      ...
      <div
        className={
          isUser
            ...
            : isArtery
            ? 'bg-black border border-samara-warm/30 text-samara-warm rounded-none px-5 py-3 max-w-[85%] md:max-w-[75%] lg:max-w-[65%] font-artery terminal-prompt break-words'
